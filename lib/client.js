        ...
        diffText !== null ? React.createElement('div', { className: 'tm-modal', onClick: () => setDiffText(null) },
          React.createElement('div', { className: 'tm-modal-box', onClick: (e) => e.stopPropagation() },
            React.createElement('div', { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid var(--dsw-alias-border-l2)', paddingBottom: 10 } },
              React.createElement('span', { style: { fontWeight: 600, fontSize: 14, color: 'var(--dsw-alias-label-primary)' } }, 'Unified Diff'),
              React.createElement('button', { className: 'tm-btn', onClick: () => setDiffText(null) }, t.close)
            ),
            React.createElement('pre', { className: 'tm-preview' }, diffText || '(empty diff)')
          )
        ) : null
      );
    }
